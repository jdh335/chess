...
public class EscapeSequences {
    ...
    public static final String SET_BG_CB_LIGHT_COLOR = SET_BG_COLOR + "144m";
    public static final String SET_BG_CB_DARK_COLOR = SET_BG_COLOR + "94m";


    public static final String PIECE_BORDER = "\u200a" + "\u200a" + "\u2009";
    public static final String PIECE_SQUARE = PIECE_BORDER + "%s" + PIECE_BORDER;
